...
class PascalMultilabelDataLayerSync(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        # print('-------------------')
        # -------------------
        # {'pascal_root': '/home/software/caffe/data/pascal/VOC2012', 'im_shape': [227, 227], 'split': 'val',
        #  'batch_size': 128}
        # -------------------
        params = eval(self.param_str)
        # print('-------------------')
        # print(type(self.param_str))
        # print('-------------------')
        # -------------------
        # < type
        # 'str' >
        ...
        #  '__subclasshook__', '__weakref__', 'channels', 'count', 'data', 'diff', 'height', 'num', 'reshape', 'shape',
        #  'width']
        # -------------------

        # print('-------------------')
        # print(type(top[1].data))        # <type 'numpy.ndarray'>
        # print('-------------------')
        print(top[1].data.shape)    # (128, 20)
        print(top[1].num, ';', top[1].count)   # (128, ';', 2560)
